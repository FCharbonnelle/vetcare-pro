...
/**
 * ⚡ Optimization: Wrapped VetCard in React.memo to prevent unnecessary re-renders.
 * Expected impact: Improves horizontal scroll performance and reduces Dashboard re-render overhead.
 */
