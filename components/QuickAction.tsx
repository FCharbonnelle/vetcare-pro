...
/**
 * QuickAction component for dashboard shortcuts.
 * Memoized to prevent re-renders when parent state changes.
 */
export const QuickAction: React.FC<QuickActionProps> = React.memo(function QuickAction({ icon: Icon, label, color, onPress }) {
  return (
