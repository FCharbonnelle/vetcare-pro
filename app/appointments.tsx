...
export default function AppointmentsScreen() {
  ...
  // Performance optimization: Memoize calendar properties
  // This prevents recalculating month data on every selectedDay state change
  ...
  // Performance optimization: Memoize the set of days with appointments
  // Prevents re-filtering and mapping appointments on every minor state update
