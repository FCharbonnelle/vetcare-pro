...
// BOLT OPTIMIZATION: Memoized ApptCard to prevent re-renders on keystrokes in the modal.
...
export default function AppointmentsScreen() {
  ...
  // BOLT OPTIMIZATION: Memoize appointment lists and days to prevent recalculation on modal text input changes.
  ...
  const selectedAppts = useMemo(() => selectedDay
    ...
    : appointments.filter(a => {
      ...
      }).slice(0, 5), [appointments, selectedDay, year, month]);
