...
/**
 * Optimized HistoryItem component using React.memo and extracted to module scope.
 *
 * Performance Impact:
 * - Prevents complete unmount/remount cycles when the parent (HistoryScreen) re-renders.
 * - Reduces re-renders from ~28 per keystroke to 0 when typing in the "Add Record" modal.
 */
