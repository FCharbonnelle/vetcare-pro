...
// ⚡ OPTIMIZATION: Extracted HistoryItem to module scope and wrapped in React.memo.
// Defining components inside a parent component causes them to be recreated on every render,
// leading to a complete unmount/remount cycle of the child subtree.
// Moving it here and using React.memo prevents redundant re-renders and unmounts when the parent state (like newTitle) updates.
const HistoryItem = React.memo(({ icon: Icon, title, date, type, color = "#A855F7" }: any) => {
  return (
