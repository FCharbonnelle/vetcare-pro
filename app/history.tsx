...
/**
 * Memoized HistoryItem component extracted to module scope to prevent
 * unnecessary re-renders when the parent component state updates.
 * Reduces render counts during modal input interactions from ~4 per keystroke to 0.
 */
