...
/**
 * Optimized HistoryItem component extracted to module scope and memoized.
 * Defines the component outside of HistoryScreen to prevent it from being
 * re-created on every parent render, which would cause complete unmount/remount.
 * React.memo ensures it only re-renders if its props actually change.
 */
