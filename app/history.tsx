...
// Optimization: Extracted HistoryItem to module scope and wrapped with memo.
// Defining component functions inside the render body causes a complete unmount/remount
// cycle on every parent update. Extracting it preserves state and reduces render overhead.
