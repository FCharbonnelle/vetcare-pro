...
/**
 * Optimized HistoryItem component using React.memo to prevent unnecessary re-renders.
 * Since this component is static and doesn't depend on parent state changes,
 * memoization avoids the overhead of reconciliation when the list parent updates.
 */
