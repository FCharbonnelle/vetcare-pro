...
/**
 * BOLT OPTIMIZATION: HistoryItem extracted to module scope and wrapped in memo.
 *
 * WHY: Defining components inside parent render functions causes them to be
 * re-created on every render, triggering expensive unmount/remount cycles.
 * Moving this outside and using memo ensures it only re-renders when props change,
 * which is critical for smooth interactions like typing in the add-record modal.
 */
