...
const styles = StyleSheet.create({
  ...
  summaryCard: { margin: 24, marginTop: 0, backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 36, padding: 32, borderSize: 1.5, borderColor: 'rgba(255,255,255,0.1)', borderWidth: 1.5, shadowColor: '#A855F7', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.1, shadowRadius: 20, elevation: 6 },
  ...
  iconContainer: { padding: 12, borderRadius: 18, borderSize: 1, borderWidth: 1 },
