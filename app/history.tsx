 ...
 * 1. Extracted from the main HistoryScreen render body to module scope to prevent
 *    unnecessary unmounting/remounting on every parent render (caused by reference changes).
 * 2. Wrapped in React.memo to prevent re-renders when the parent's state
 *    (e.g., the "Nouvel Historique" modal input) changes.
 *
 * EXPECTED IMPACT:
 * Reduces re-renders of list items to 0 when typing in the modal or performing
 * other state updates that don't affect the records list.
 */
