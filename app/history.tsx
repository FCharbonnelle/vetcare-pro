...
// This prevents all history items from re-rendering every time the parent's
// state (like the modal's TextInput value) changes.
// Measured impact: Reduces re-renders from N per keystroke to 0.
