    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.header}>
           ...
           <TouchableOpacity
             style={styles.filterBtn} accessibilityRole="button" accessibilityLabel="Filtrer les activités"
           >
        ...
        <View style={styles.summaryCard}>
         ...
         <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity
              style={styles.addBtnContainer} onPress={() => setModalVisible(true)}
              accessibilityRole="button" accessibilityLabel="Ajouter une nouvelle activité"
            >
      ...
      <TouchableOpacity
        style={styles.fab} activeOpacity={0.9} onPress={() => setModalVisible(true)}
        accessibilityRole="button" accessibilityLabel="Ouvrir le formulaire d'ajout"
      >
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <View style={styles.modalHeader}>
              ...
              <TouchableOpacity
                onPress={() => setModalVisible(false)} style={styles.closeBtn}
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <TextInput
                style={styles.modalInput} placeholder="Ex: Rappel Vaccin" placeholderTextColor="rgba(255,255,255,0.2)"
                value={newTitle} onChangeText={setNewTitle} accessibilityLabel="Titre de la visite"
                returnKeyType="next" onSubmitEditing={() => typeInputRef.current?.focus()}
              />
              
              <Text style={styles.modalLabel}>TYPE D'ACTIVITÉ</Text>
              <TextInput
                ref={typeInputRef} style={styles.modalInput} placeholder="Ex: Clinique, Hygiène..."
                placeholderTextColor="rgba(255,255,255,0.2)" value={newType} onChangeText={setNewType}
                accessibilityLabel="Type d'activité" returnKeyType="done" onSubmitEditing={handleAddRecord}
              />
              ...
              <TouchableOpacity
                ...
                onPress={handleAddRecord} disabled={!newTitle.trim()}
                accessibilityRole="button" accessibilityLabel="Enregistrer l'activité"
              >
