...
/**
 * HistoryItem component extracted and memoized to prevent unnecessary re-renders.
 * Defining this inside the parent component's render body causes it to be re-created
 * and re-rendered on every parent state update (e.g., when typing in the modal).
 */
