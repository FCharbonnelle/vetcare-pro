...
/**
 * HistoryItem component extracted to module scope and memoized to prevent
 * unnecessary re-renders when parent state changes (e.g., during text input in modals).
 *
 * Expected Impact: Reduces re-renders of list items to zero when typing in the 'New Record' modal.
 */
