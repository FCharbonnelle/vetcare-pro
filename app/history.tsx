...
/**
 * Optimized HistoryItem component extracted to module scope and wrapped in memo.
 * Prevents unmount/remount cycles and unnecessary re-renders when parent state changes.
 */
