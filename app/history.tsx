 ...
 * Extracted HistoryItem to module scope and wrapped with React.memo.
 * Previously, it was defined inside HistoryScreen, causing it to be recreated
 * on every render of the parent. Now it only re-renders if its props change.
 */
