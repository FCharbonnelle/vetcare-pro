...
/**
 * Optimized TypeCard: Extracted and memoized to avoid re-creation on parent render.
 * Prevents unnecessary sub-tree reconciliation during onboarding step transitions.
 */
