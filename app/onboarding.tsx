...
export default function Onboarding() {
  ...
  const handleSelectType = useCallback((selectedType: string) => {
        ...
        {step === 2 && (
          <View style={styles.stepContent}>
            ...
            <View style={styles.typeGrid}>
              <TypeCard icon={Dog} label="Chien" isSelected={type === 'Chien'} onPress={() => handleSelectType('Chien')} />
              <TypeCard icon={Cat} label="Chat" isSelected={type === 'Chat'} onPress={() => handleSelectType('Chat')} />
              <TypeCard icon={Plus} label="Autre" isSelected={type === 'Autre'} onPress={() => handleSelectType('Autre')} />
            </View>
          </View>
        )}
