        ...
        {step === 2 && (
          <View style={styles.stepContent}>
            ...
            <View style={styles.typeGrid}>
              <TypeCard icon={Dog} label="Chien" isSelected={type === 'Chien'} onPress={handleSelectType} />
              <TypeCard icon={Cat} label="Chat" isSelected={type === 'Chat'} onPress={handleSelectType} />
              <TypeCard icon={Plus} label="Autre" isSelected={type === 'Autre'} onPress={handleSelectType} />
            </View>
          </View>
        )}
