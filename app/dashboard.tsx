...
import { View, Text, ScrollView, TouchableOpacity, Image, StyleSheet, SafeAreaView, Animated, Dimensions, Platform, Modal, FlatList, ListRenderItem } from 'react-native';
...
export default function Dashboard() {
  ...
  // ⚡ Optimization: Memoize toggle to prevent QuickAction/NotifItem re-renders
  const toggleNotifModal = useCallback((visible: boolean) => {
  ...
  const navigateToAiAssist = useCallback(() => {
  ...
  // ⚡ Optimization: Memoize renderItem for FlatList
  const renderVetItem: ListRenderItem<typeof VET_DATA[0]> = useCallback(({ item }) => (
    <VetCard {...item} />
  ), []);
    ...
    <SafeAreaView style={styles.container}>
      ...
      <Animated.ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={[styles.scroll, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}>
        ...
        <View style={styles.header}>
           ...
           <TouchableOpacity onPress={() => toggleNotifModal(true)} style={styles.notifBtn}>
        ...
        <View style={styles.modalOverlay}>
           <View style={styles.modalContent}>
              <View style={styles.modalHeader}>
                 ...
                 <TouchableOpacity onPress={() => toggleNotifModal(false)}>
