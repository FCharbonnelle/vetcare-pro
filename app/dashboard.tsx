...
export default function Dashboard() {
  ...
  const handleNavigateSettings = useCallback(() => router.push('/settings' as any), [router]);
  const handleNavigatePetProfile = useCallback(() => router.push('/pet-profile' as any), [router]);
  const handleNavigateAIAssist = useCallback(() => router.push('/ai-assist' as any), [router]);
  const handleNavigateHistory = useCallback(() => router.push('/history' as any), [router]);
  const handleNavigateMap = useCallback(() => router.push('/map' as any), [router]);
    ...
    <SafeAreaView style={styles.container}>
      ...
      <Animated.ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={[styles.scroll, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}>
        ...
        <View style={styles.header}>
           ...
           <TouchableOpacity onPress={handleOpenNotifs} style={styles.notifBtn} accessibilityRole="button" accessibilityLabel="Notifications">
             <Bell color="white" size={24} />
             <View style={styles.badge} />
           </TouchableOpacity>
           
           <TouchableOpacity onPress={handleNavigateSettings} style={styles.avatarBtn} accessibilityRole="button" accessibilityLabel="Profil utilisateur">
        ...
        {/* ── HERO PET CARD ── */}
        <TouchableOpacity style={styles.heroCard} activeOpacity={0.9} onPress={handleNavigatePetProfile} accessibilityRole="button">
        ...
        <View style={styles.actionsGrid}>
           <QuickAction icon={Zap} label="IA Assist" color="#A855F7" onPress={handleNavigateAIAssist} />
           <QuickAction icon={Activity} label="Santé" color="#10B981" onPress={handleNavigateHistory} />
           <QuickAction icon={MapPin} label="Trouver" color="#3B82F6" onPress={handleNavigateMap} />
        </View>
        ...
        <View style={styles.sectionHeader}>
           ...
           <TouchableOpacity onPress={handleNavigateMap} accessibilityRole="button"><Text style={styles.seeAll}>Voir Carte</Text></TouchableOpacity>
        </View>
        <FlatList
          data={VET_DATA}
      ...
      {/* NOTIFICATIONS MODAL */}
      <Modal visible={notifModalVisible} transparent animationType="fade" onRequestClose={handleCloseNotifs}>
        <View style={styles.modalOverlay}>
           <View style={styles.modalContent}>
              <View style={styles.modalHeader}>
                 <Text style={styles.modalTitle}>Notifications</Text>
                 <TouchableOpacity onPress={handleCloseNotifs} accessibilityRole="button">
