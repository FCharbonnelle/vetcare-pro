...
/**
 * ⚡ Optimization: Extracted and memoized WeightLineChart to avoid expensive
 * SVG re-calculations during dashboard animations or modal toggles.
 */
...
export default function Dashboard() {
  ...
  /**
   * ⚡ Optimization: Memoized navigation handlers to maintain referential
   * stability for memoized QuickAction components.
   */
