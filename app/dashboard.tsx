...
export default function Dashboard() {
  ...
  const handleOpenNotif = useCallback(() => setNotifModalVisible(true), []);
  const handleCloseNotif = useCallback(() => setNotifModalVisible(false), []);
  const navigateToSettings = useCallback(() => router.push('/settings' as any), [router]);
  const navigateToPetProfile = useCallback(() => router.push('/pet-profile' as any), [router]);
  const navigateToAiAssist = useCallback(() => router.push('/ai-assist' as any), [router]);
    ...
    <SafeAreaView style={styles.container}>
      ...
      <Animated.ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={[styles.scroll, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}>
        ...
        <View style={styles.header}>
           ...
           <TouchableOpacity onPress={handleOpenNotif} style={styles.notifBtn}>
