...
/**
 * WeightLineChart - Memoized expensive SVG component to prevent
 * recalculations during Dashboard re-renders.
 * Expected Impact: Reduces main thread load during dashboard state updates.
 */
